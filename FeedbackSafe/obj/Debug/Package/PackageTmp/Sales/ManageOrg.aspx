<%@ Page Title="" Language="C#" MasterPageFile="~/Sales/Sales.Master" AutoEventWireup="true" CodeBehind="ManageOrg.aspx.cs" Inherits="FeedbackSafe.Sales.ManageOrg" %>
...
<!--BEGIN HIDDEN LABELS-->
    <asp:Label ID="lbl_NewOrgID" runat="server" Visible="false"></asp:Label>
