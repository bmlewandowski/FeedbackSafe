<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Agent.Master" AutoEventWireup="true" CodeBehind="ManageUsers.aspx.cs" Inherits="FeedbackSafe.Agent.ManageUsers" %>
...
<asp:LinkButton ID="lbn_massUserDiv" runat="server" Font-Size="14px" Font-Bold="true" onclick="lbn_massUserDiv_Click" ToolTip="Show Add User">User Mass Import</asp:LinkButton>

<br /><br />

<!--BEGIN MASS USER DIV-->
<div id="massUser" runat="server" visible="false">

<asp:DropDownList ID="ddl_selectOrg" runat="server">
</asp:DropDownList>

<br /><br />
<asp:FileUpload ID="upl_usercsv" runat="server" />

<asp:RegularExpressionValidator ID="val_usercsv" runat="server" ControlToValidate="upl_usercsv" ValidationExpression="^.*\.(csv|CSV)$" ErrorMessage="* Must be CSV format" ValidationGroup="uploadCSV"></asp:RegularExpressionValidator>
<br /><br />
    <asp:Button ID="btn_uploadUsers" runat="server" Text="Load Users" onclick="btn_uploadUsers_Click" ValidationGroup="uploadCSV" />
