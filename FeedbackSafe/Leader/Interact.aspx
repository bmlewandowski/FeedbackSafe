<%@ Page Title="" Language="C#" MasterPageFile="~/Leader/Leader.Master" AutoEventWireup="true" CodeBehind="Interact.aspx.cs" Inherits="FeedbackSafe.Leader.Interact" %>
...
<!--BEGIN PRIVATE BADGE-->
    <div class="interact_private_badge">
        <asp:ImageButton ID="imb_setPrivate" runat="server" ImageUrl="~/Images/Interface/private_small_faded.png" style="vertical-align:middle;" onclick="imb_setPrivate_Click" />
    </div>
<!--BEGIN LEADER INFO-->
...
<!--BEGIN BUBBLE BODY-->
                ...
                <asp:ImageButton ID="imb_setApproved" runat="server" CommandName="Approve" CommandArgument='<%#Eval("CommentID")%>' ImageUrl="/Images/Interface/not_approved.png" CssClass="interact_approve" />
