...
namespace FeedbackSafe.Leader
{
    public partial class ManageLeaders : Page
    {
        ...
        protected void BindOrg()
        {
            ...
            {
                Response.Redirect("/Leader/Error.aspx?ErrorCode=OrgID_Session_Was_Lost");
            }
        }
